					...
					<div className="col-lg-8 col-sm-12 row justify-content-center content">
						...
						<div className="col-lg-6 col-sm-6 content">
							...
							<div className="form-floating form-group">
								<input type="text" className="form-control border-0 border-bottom border-success shadow-none text-success fw-bold ginput" id="floatingInput" placeholder="name@example.com" required />
								<label className="glabel" htmlFor="floatingInput">Nickname</label>
							</div>
							<div className="form-floating form-group">
