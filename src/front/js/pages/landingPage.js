      ...
      <div className="container">
        <div className="row d-flex align-items-center">
          <div className="col-md-6 order-md-2 text-md-start">
            ...
            <p>Design your dream garden with our intuitive digital garden tool! Create a custom layout that mirrors your garden space and choose from a variety of plant, vegetable, and flower icons to add to your design. With built-in lighting level indicators, you can plan and visualize the best spots for each plant based on their sunlight requirements. Watch your garden vision come to life in this interactive and user-friendly tool!</p>
          </div>
          <div className="col-md-6 order-md-1">
            <img
